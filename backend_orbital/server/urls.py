...
urlpatterns = [
    ...
    path('usertodaytasklist/<int:userid>/', getUserTodayTask),
    path('userrecenttasklist/<int:userid>/', getUserRecentTask),
    path('usercompletetasklist/<int:userid>/', getUserCompletedTask),
    path('userincompletetasklist/<int:userid>/', getUserIncompleteTask),
    ...
    path('tagbycategory/<int:categoryid>/', getTagbyCategory),
